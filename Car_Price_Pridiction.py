...
def main():
    ...
    p2 = st.number_input("Please enter car driven(in Kms)",100,500000,step=100)
    ...
    s2 = st.selectbox("Select the seller type",("Dealer","Indivedual"))
    ...
    p6 = st.slider("how many owners",0,5,step=1)
